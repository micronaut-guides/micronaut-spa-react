...
.server/src/main/java/example/HelloController.java
[source,java]
----
include::{sourceDir}/server/src/main/java/example/HelloController.java[indent=0]
----
...
[source,bash]
----
~ curl -X GET http://localhost:8080/Bob
  Hello, Bob!
----
